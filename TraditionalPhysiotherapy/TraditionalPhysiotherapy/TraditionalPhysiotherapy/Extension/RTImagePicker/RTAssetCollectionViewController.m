...
- (void)viewDidLoad
{
    ...
    hasAuthorized = NO;
    NSLog(@"RTAssetCollectionViewController.view.frame %@",NSStringFromCGRect(self.view.frame));
...
//    CGFloat nnn = 2.*(numberOfColumns - 1);
    CGFloat width = (self.view.width - 2.0 * (numberOfColumns - 1)) / numberOfColumns;
//    CGFloat width = (1024 - nnn) / numberOfColumns;
