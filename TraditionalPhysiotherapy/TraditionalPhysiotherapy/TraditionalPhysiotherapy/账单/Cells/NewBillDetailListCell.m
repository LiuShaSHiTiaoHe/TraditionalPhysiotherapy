...
#define signViewHeight 400
@implementation NewBillDetailListCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        totalPrice.font = [UIFont systemFontOfSize:22];
        ...
        otherPayLabel.font = [UIFont systemFontOfSize:22];
        ...
        detialLabel.font = [UIFont systemFontOfSize:22];
        ...
        balanceLabel.font = [UIFont systemFontOfSize:22];
        ...
        signtextLabel.font = [UIFont systemFontOfSize:22];
        ...
        [detailList mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.equalTo(timeImage.mas_right).offset(20);
            make.bottom.equalTo(self.mas_bottom).offset(-signViewHeight-60);
            make.right.equalTo(self.mas_right).offset(-20);
